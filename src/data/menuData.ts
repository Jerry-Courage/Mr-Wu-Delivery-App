...
export const menuItems: MenuItem[] = [
  ...
  { id: "6", name: "Fishing Panda Family Combo", description: "2 Mains, 2 Appetizers, and Large Rice. Perfect for 3-4 people.", price: 45.00, image: familyCombo, category: "Combos", isTop: true },
