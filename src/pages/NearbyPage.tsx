...
const NearbyPage = () => {
  ...
  return (
    <div className="pb-4">
      ...
      {/* Map Placeholder */}
      <div className="mx-4 mt-3 h-40 bg-muted rounded-xl flex items-center justify-center text-muted-foreground text-sm">
        🗺️ Map View
      </div>
      ...
      {/* AI Tip */}
      <div className="mx-4 mt-4 bg-secondary/10 border border-secondary/20 rounded-xl p-3">
