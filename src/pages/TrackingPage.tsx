...
const TrackingPage = () => {
  ...
  return (
    <div className="pb-20 min-h-screen bg-muted">
      ...
      {/* Desktop layout */}
      <div className="md:grid md:grid-cols-2 md:gap-6 md:px-4 md:mt-4">
        {/* Map Area */}
        <div className="h-64 md:h-full md:min-h-[350px] bg-muted md:bg-card md:rounded-2xl flex flex-col items-center justify-center relative">
        ...
        {/* Driver Card */}
        <div className="mx-4 md:mx-0 -mt-6 md:mt-0 bg-card rounded-2xl shadow-lg p-4 relative z-10">
