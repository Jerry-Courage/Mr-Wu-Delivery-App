import { ChevronRight, MapPin, CreditCard, Heart, AlertTriangle, Bell, Languages, Shield, HelpCircle, FileText, LogOut, Gift, Zap } from "lucide-react";
...
const ProfilePage = () => {
  ...
  return (
    <div className="pb-4">
      ...
      {/* Rewards */}
      <div className="mx-4 -mt-1 bg-foreground rounded-xl p-4 text-primary-foreground">
      ...
      {/* Referral Banner */}
      <div className="mx-4 mt-5 bg-foreground rounded-2xl p-4 flex items-center gap-3 overflow-hidden relative">
        <div className="flex-1">
