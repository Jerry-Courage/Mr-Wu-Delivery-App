  ...
  return (
    <div className="pb-24">
      ...
      <div className="relative">
        ...
        <button onClick={() => navigate("/checkout")} className="absolute top-4 right-4 w-9 h-9 bg-card/80 backdrop-blur rounded-full flex items-center justify-center relative">
      ...
      <div className="px-4 mt-6">
        ...
        <div className="flex gap-3 overflow-x-auto scrollbar-hide">
          {[{ name: "Hand-pulled Noodles", price: 4.50, img: sichuanNoodles, tag: "AI Match" },
            ...
            <div key={side.name} className="flex-shrink-0 w-36">
