              ...
              {step === 1 && (
                ...
                >
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              <h3 className="font-black uppercase tracking-tight text-white">{role.title}</h3>
                            </div>
                            <p className="text-sm text-neutral-400 font-medium line-clamp-1">{role.description}</p>
                          </div>
                          {selectedRole === role.id && (
                  ...
                  <Button
                    ...
                    onClick={handleNext}
                    className="w-full h-16 rounded-[2rem] bg-orange-600 hover:bg-orange-700 text-white transition-all font-black uppercase tracking-widest text-lg gap-2"
                  >
                ...
                >
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-white/5 rounded-3xl p-6 border border-white/10 space-y-4">
                      <h4 className="text-[10px] font-black uppercase tracking-widest text-neutral-500">What you get</h4>
                      <div className="space-y-3">
                        {currentRoleData.features.map((feature, i) => (
                          <motion.div
                            ...
                            key={i}
                            className="flex items-center gap-3 text-neutral-300 text-sm font-medium"
                          >
                    ...
                    <div className="flex gap-4">
                      <div className="flex-1 p-4 bg-white/5 rounded-2xl border border-white/10 text-center">
                        ...
                        <p className="text-[10px] text-neutral-500 uppercase font-black">Secure</p>
                        <p className="text-sm font-black text-white">Safe Access</p>
                      </div>
                      <div className="flex-1 p-4 bg-white/5 rounded-2xl border border-white/10 text-center">
                        <Clock className="mx-auto mb-2 text-blue-400" size={20} />
                        <p className="text-[10px] text-neutral-500 uppercase font-black">Live</p>
                  ...
                  <Button
                    onClick={handleNext}
                    className="w-full h-16 rounded-[2rem] bg-orange-600 hover:bg-orange-700 text-white transition-all font-black uppercase tracking-widest text-lg gap-2 shadow-xl shadow-orange-600/10"
                  >
